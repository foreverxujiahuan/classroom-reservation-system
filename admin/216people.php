...
<body background="img/4.jpg" style="background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
  ...
  <?php
    ...
    // mysqli_query("set names uft8");
     ...
     $sql="select count(id) from people2";
     ...
     $sql="select * from people2 limit ".($pageNow-1)*$pageSize.",$pageSize";
 ...
 <h1>216人员信息</h1>
   ...
   <?php
    ...
    /* for($i=1;$i<=$pageCount;$i++){
     ...
     if($pageNow>1){
         $prePage=$pageNow-1;
         echo "<a href='216people.php?pageNow=$prePage'>上一页</a>&nbsp;";
     }
     if($pageNow<$pageCount){
         $nextPage=$pageNow+1;
         echo "<a href='216people.php?pageNow=$nextPage'>下一页</a>&nbsp;";
     }
     //echo "<a href='#'><<</a>&nbsp;";
      //echo "<a href='#'>>></a>&nbsp;";
     ...
     echo "<br/><br/>";
     ?>
     <form action="216people.php" class="form1" >
