...
<body background="img/18.jpg" style="background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
  <div>
  <?php
     $conn=mysqli_connect("localhost","root","root","demo");
    // mysqli_query("set names uft8");
     mysqli_select_db($conn,"date");
     $pageSize=10;
     ...
     $sql="select * from date limit ".($pageNow-1)*$pageSize.",$pageSize";
